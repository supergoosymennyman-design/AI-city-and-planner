/**
 * settings.js — Settings panel for Passport Budget Allocator
...
const Settings = (() => {
  ...
  const STORAGE_KEY = 'passport-budget-settings';
  const DEFAULTS = {
    rate: 0.85,
    volume: 0.9,
    voiceURI: '',
  ...
  function updateSessionMetrics() {
    ...
    metricsEl.innerHTML =
      ...
      '<div class="sm-row"><span>VAD</span><span>' + vadSegments + '</span></div>';
  }
