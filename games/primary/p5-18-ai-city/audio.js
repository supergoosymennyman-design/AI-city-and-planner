...
const Audio = (() => {
  ...
  function sq(notes,off){notes.forEach((n,i)=>setTimeout(()=>p(n.f,n.d,n.t||'sine',n.v||0.08,true),off||0+i*(n.g||80)));}
  return {
    ...
    scan:()=>{p(1000,0.05,'sine',0.05);setTimeout(()=>p(1200,0.05,'sine',0.05),80);},
