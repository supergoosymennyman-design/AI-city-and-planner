/**
 * conversation.js — Nova conversational AI for Compute Fee Meter
 *
...
const Conversation = (() => {
  ...
  // DOM refs
  let speechBubbleEl, speechTextEl, avatarEl;
  let textInputArea, textInput, textSendBtn;
  let idleTimer = null;
  let _avatarTapped = false; // tracks if child initiated via avatar tap
  ...
  function showVisualPrompt() {
    // Visual-only — never auto-speak (PASSIVE AI RULE)
