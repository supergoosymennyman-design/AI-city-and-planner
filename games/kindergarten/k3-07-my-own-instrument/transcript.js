/**
 * transcript.js — Conversation history storage for K3-07 My Own Instrument
 *
 * Stores child→AI message pairs in memory with optional timestamp.
 * Provides methods to add entries, retrieve history, and clear.
 */
...
var GameTranscript = (() => {
  ...
  function getFormatted() {
    return entries.map(e => {
      ...
      const label = e.role === 'child' ? 'You' : 'AI';
  ...
  /**
   * Render the transcript drawer UI.
