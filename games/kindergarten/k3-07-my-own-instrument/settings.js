/**
 * settings.js — Settings panel for K3-07 My Own Instrument
 *
...
var GameSettings = (() => {
  const STORAGE_KEY = 'k3-07-my-own-instrument-settings';
  ...
  /**
   * Build the settings modal HTML and wire up events.
   * @param {HTMLElement} container - Element to append the modal to
   */
