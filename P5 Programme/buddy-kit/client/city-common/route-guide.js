...
/**
 * Verify the road-space transform used by the renderer. The builder now renders
 * the plan geometry-preservingly, so this is normally the identity transform
 * (scale 1, no translation). It is still derived from the road points rather
 * than assumed, so older/other transforms are detected and rejected.
 */
