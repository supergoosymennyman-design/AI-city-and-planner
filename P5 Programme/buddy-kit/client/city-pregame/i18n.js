...
export const DICT = {
  en: {
    ...
    'pg.intro.sub': 'Explore four recipes the planner uses, then try them in your own city.',
    ...
    'pg.unlock': '\ud83c\udfd9\ufe0f Open the planner \u2192',
    'pg.saveProgress': '\ud83d\udcbe Save my city + progress',
    'pg.restart': 'Start over',
    'pg.downloadHint.locked': 'You can open the planner whenever you are ready.',
    'pg.downloadHint.ready': 'You can open the planner whenever you are ready. Save your city + progress to keep one backup file for any tablet.',
  ...
  'zh-Hant': {
      ...
      "pg.intro.sub": "探索規劃工具使用的四個方法，然後在自己的城市試試看。",
      "pg.start": "開始訓練",
      "pg.rooms.aria": "訓練室",
      "pg.finale.aria": "畢業",
      ...
      "pg.unlock": "🏙️ 開啟規劃工具 →",
      "pg.saveProgress": "💾 儲存我的城市與進度",
      "pg.restart": "重新開始",
      "pg.downloadHint.locked": "你隨時都可以開啟規劃工具。",
      "pg.downloadHint.ready": "你隨時都可以開啟規劃工具。儲存城市和進度，便可保留一個在任何平板使用的備份檔案。",
      "pg.nav.aria": "訓練室進度",
      "pg.nav.room": "訓練室 {n}",
      "pg.modal.title": "重新開始？",
