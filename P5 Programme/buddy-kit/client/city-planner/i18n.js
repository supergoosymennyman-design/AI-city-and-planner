...
const DICT = {
  en: {
    ...
    'planner.cloud.saveFail': '⚠️ The cloud isn\'t reachable right now — your city is still safe on this tablet. Tap 💾 Save to keep a backup file.',
  ...
  'zh-Hant': {
    ...
    'planner.cloud.saveFail': '⚠️ 暫時連不上雲端 — 你的城市仍安全地保存在這部平板電腦上。可點 💾 儲存以下載備份檔案。',
