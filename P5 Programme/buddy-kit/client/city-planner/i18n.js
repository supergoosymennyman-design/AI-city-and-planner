...
const DICT = {
  en: {
    ...
    'planner.example': '🏙️ Example city',
    'planner.exampleTitle': 'Explore the example city in 3D without replacing your plan',
    ...
    'planner.decorateCity': '🎨 Decorate city',
    'planner.decorateCityTitle': 'Save your plan and decorate it in 3D',
    'planner.redo': '↪️ Redo',
    'planner.redoTitle': 'Redo last undone change',
    ...
    'planner.viewCityTitle': 'Save your city and explore it in 3D',
    ...
    "planner.mymove.scoreQuestion": "What city need does this next move address?",
    ...
    'planner.autosave.saved': 'Saved on this device',
    'planner.autosave.backup': 'Backup recommended',
    'planner.autosave.error': 'Could not save — download a backup',
    ...
    'planner.toast.redo': '↪️ Redone',
    'planner.toast.nothingRedo': 'Nothing to redo',
    ...
    'planner.template.radial': 'Rings & Spokes',
    'planner.template.superblocks': 'Garden Superblocks',
    'planner.template.culdesacs': 'Quiet Neighbourhoods',
    'planner.template.twincenters': 'Twin Centres',
    'planner.template.rivercity': 'Green Corridor',
    'planner.template.coastal': 'Curved District',
    'planner.template.diagonal': 'Diagonal Boulevard',
    'planner.template.grid.note': 'Regular roomy blocks with two central avenues.',
    'planner.template.radial.note': 'Two orbital routes and eight spokes around a central park.',
    'planner.template.superblocks.note': 'Large green districts with calm local U-shaped streets.',
    'planner.template.culdesacs.note': 'A collector circuit with six peaceful turning streets.',
    'planner.template.twincenters.note': 'Two compact centres joined by two useful boulevards.',
    'planner.template.rivercity.note': 'Two developed sides with a broad park corridor and crossings.',
    'planner.template.coastal.note': 'Curved avenues with unusual but still buildable plots.',
    'planner.template.diagonal.note': 'A single diagonal shortcut across coarse, useful blocks.',
    ...
    'planner.mymove.introPre': 'The planner has chosen the next step from the same plan as Optimise. ',
    'planner.mymove.introStrong': 'You\'re in charge',
    'planner.mymove.introPost': ' — predict why this step matters.',
    ...
    'planner.mymove.greedyWhy': ' It follows the shared safety, coverage, access, zoning, district, composition, then mayor-priority order.',
    'planner.mymove.ruleTitle': 'Hill-climbing rule:',
    'planner.mymove.ruleBody': 'fix hard safety and viability needs first, then improve the score. A necessary district step can show progress even when its score is neutral. Then plan again — one step at a time.',
  ...
  'zh-Hant': {
    ...
    'planner.example': '🏙️ 示範城市',
    'planner.exampleTitle': '在 3D 中探索示範城市，不會取代你的規劃',
    ...
    'planner.decorateCity': '🎨 佈置城市',
    'planner.decorateCityTitle': '儲存規劃並在 3D 城市中佈置',
    'planner.redo': '↪️ 重做',
    'planner.redoTitle': '重做剛才復原的改動',
    'planner.clear': '🗑️ 清除',
    ...
    'planner.viewCityTitle': '儲存你的城市並在 3D 中探索',
    ...
    "planner.mymove.scoreQuestion": "下一個改動會處理城市哪一項需要？",
    ...
    'planner.autosave.saved': '已儲存在此裝置',
    'planner.autosave.backup': '建議備份',
    'planner.autosave.error': '未能儲存 — 請下載備份',
    ...
    'planner.toast.redo': '↪️ 已重做',
    'planner.toast.nothingRedo': '沒有可以重做的',
    ...
    'planner.template.radial': '環路與放射道路',
    'planner.template.superblocks': '花園超級街區',
    'planner.template.culdesacs': '安靜社區',
    'planner.template.twincenters': '雙市中心',
    'planner.template.rivercity': '綠色走廊',
    'planner.template.coastal': '曲線街區',
    'planner.template.diagonal': '斜向大道',
    'planner.template.grid.note': '規則而寬敞的街區，中間有兩條主要大道。',
    'planner.template.radial.note': '兩條環路和八條放射道路圍繞中央公園。',
    'planner.template.superblocks.note': '大型綠色街區，內有安靜的 U 形小路。',
    'planner.template.culdesacs.note': '一個集散環路連接六條安靜的轉彎街。',
    'planner.template.twincenters.note': '兩個緊湊中心由兩條實用大道連接。',
    'planner.template.rivercity.note': '兩邊都有發展區，中間是有過路點的寬闊公園走廊。',
    'planner.template.coastal.note': '曲線大道形成特別而仍可建設的地塊。',
    'planner.template.diagonal.note': '一條斜向捷徑穿過寬闊實用的街區。',
    ...
    'planner.mymove.introPre': '規劃器已從「優化」共用的方案選出下一步。',
    'planner.mymove.introStrong': '由你話事',
    'planner.mymove.introPost': ' — 猜猜這一步為甚麼重要。',
    ...
    'planner.mymove.greedyWhy': ' 它依次考慮安全、覆蓋、可達性、分區、區域分布、城市組合，最後才按市長優先事項排序。',
    'planner.mymove.ruleTitle': '爬山演算法規則：',
    'planner.mymove.ruleBody': '先處理安全和城市可行性，再提高分數。必要的區域步驟即使分數不變，也會顯示目標進度；之後再逐步重新規劃。',
