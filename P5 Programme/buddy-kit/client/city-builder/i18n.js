...
export const DICT = {
  en: {
    ...
    'coach.c2b': 'Walk up to AI Workshop or Fit Studio and tap Enter to visit.',
    ...
    'demo.viewing': '🏙️ Passiona Demo · Example city',
  ...
  'zh-Hant': {
    ...
    'coach.c2t': '玩小遊戲',
    'coach.c2b': '走到 AI 工坊或造型工作室前，點「進入」前往。',
    'coach.c3t': '佈置你的城市',
    ...
    'demo.viewing': '🏙️ Passiona 示範 · 範例城市',
