...
export function prepareBuildingMaterials(root){root.traverse(o=>{if(!o.isMesh)return;for(const m of Array.isArray(o.material)?o.material:[o.material]){
 ...
 if(!m.map?.image || m.emissiveMap)continue;
